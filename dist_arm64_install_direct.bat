...
set "FAILED=0"
set "LOCKED=0"
set "TIGERCLAW_ARM64_REGISTER_DIRECT=1"

call :log "Install TigerClaw Windows on Arm package (ARM64 direct diagnostic)"
echo ====================================
echo Install TigerClaw for Windows on Arm - ARM64 direct diagnostic
echo ====================================
...
echo [Info] 64-bit TSF COM will be registered directly to TigerClawARM64.dll for UWP/ARM64 activation.
...
if "!FAILED!"=="1" goto :failed
call :register "ARM64 direct" "%REGSVR64%" "%TARGET_ARM64%" || set "FAILED=1"
...
call :verify_registry_path "ARM64 direct" "HKCR\CLSID\%TIP_CLSID%\InprocServer32" "%TARGET_ARM64%" || set "FAILED=1"
...
call :popup "TigerClaw" "Diagnostic install completed with ARM64 direct TSF registration. Keep this release folder because Core runs from here." "Info"
exit /b 0

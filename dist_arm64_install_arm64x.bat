...
call :log "Install TigerClaw Windows on Arm package (ARM64X wrapper compatibility)"
echo ====================================
echo Install TigerClaw for Windows on Arm - ARM64X wrapper compatibility
echo ====================================
...
call :popup "TigerClaw" "ARM64X wrapper install completed. Use this only to test x64-emulated compatibility." "Info"
exit /b 0

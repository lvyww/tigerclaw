...
namespace TigerClaw.Dialog
{
    ...
    internal static class ConfigSettingOrder
    {
        private static readonly string[] Keys =
        {
            ...
            "整句允许全码组句白名单", "整句自动提前上屏", "整句Tab自学习", "全拼纠正学习", "全拼简拼", "全拼拼写兼容", "全拼错拼纠正", "全拼模糊音n-l", "全拼模糊音z-zh", "全拼模糊音c-ch", "全拼模糊音s-sh", "全拼模糊音en-eng", "全拼模糊音in-ing", "全拼模糊音an-ang", "拼音英文候选", "拼音表情候选", "拼音繁体输出", "保留最少编码数量",
            // Native hook
